...
WALL_HIT.src = "BRICK-BREAKER GAME_sound_wall.mp3";

const LIFE_LOST = new Audio();
LIFE_LOST.src = "BRICK-BREAKER GAME_sound_life_lost.mp3";

const PADDLE_HIT = new Audio();
PADDLE_HIT.src = "BRICK-BREAKER GAME_sound_paddle_hit.mp3";

const WIN = new Audio();
WIN.src = "win.mp3";

const BRICK_HIT = new Audio();
BRICK_HIT.src = "BRICK-BREAKER GAME_sound_brick_hit.mp3";
